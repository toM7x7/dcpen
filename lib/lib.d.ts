...
export { DEFAULT_BRUSH, DEFAULT_RIBBON_SIZE, PEN_COLORS, RAINBOW, getStrokeOwnerId, getStrokePenIndex, getNextPenToolMode, speedToWidthValue } from './pen/types';
export type { BrushDefinition, RibbonGeometryData } from './pen/brushes';
export type { BrushId, PenToolMode, Stroke, StrokePoint } from './pen/types';
